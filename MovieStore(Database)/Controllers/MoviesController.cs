...
namespace MovieStore.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,DownloadURL,Rating,ImageURL")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,DownloadURL,Rating,ImageURL")] Movie movie)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult InsertNewClient(int id)
        {
            ...
            model.Clients = db.Clients.ToList(); // lista od site klienti
